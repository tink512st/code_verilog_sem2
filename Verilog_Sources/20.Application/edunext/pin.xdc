...
set_property PACKAGE_PIN V16 [get_ports {sel_freq[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_freq[0]}]
set_property PACKAGE_PIN W16 [get_ports {sel_freq[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sel_freq[1]}]
